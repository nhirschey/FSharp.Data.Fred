...
#r "nuget: FSharp.Data.Fred,0.1.0-beta.1" // Use a specific version
...
Count of search hits: 10520
Top 10 results:
  1. 10-Year Treasury Constant Maturity Minus 2-Year Treasury Constant Maturity 
         Id: T10Y2Y     Period: 1976-06-01 to 2022-03-18  Freq: Daily 

  2. 10-Year Treasury Constant Maturity Minus 2-Year Treasury Constant Maturity 
         Id: T10Y2YM    Period: 1976-06-01 to 2022-02-01  Freq: Monthly 

  3. 10-Year Breakeven Inflation Rate 
         Id: T10YIE     Period: 2003-01-02 to 2022-03-18  Freq: Daily 

  4. Market Yield on U.S. Treasury Securities at 10-Year Constant Maturity 
         Id: DGS10      Period: 1962-01-02 to 2022-03-17  Freq: Daily 

  5. 10-Year Breakeven Inflation Rate 
         Id: T10YIEM    Period: 2003-01-01 to 2022-02-01  Freq: Monthly 

  6. Market Yield on U.S. Treasury Securities at 10-Year Constant Maturity 
         Id: GS10       Period: 1953-04-01 to 2022-02-01  Freq: Monthly 

  7. Market Yield on U.S. Treasury Securities at 10-Year Constant Maturity 
         Id: WGS10YR    Period: 1962-01-05 to 2022-03-11  Freq: Weekly, Ending Friday 

  8. 10-Year Treasury Constant Maturity Minus 3-Month Treasury Constant Maturity 
         Id: T10Y3M     Period: 1982-01-04 to 2022-03-18  Freq: Daily 

  9. Market Yield on U.S. Treasury Securities at 10-Year Constant Maturity, Inflation-Indexed 
         Id: DFII10     Period: 2003-01-02 to 2022-03-17  Freq: Daily 

 10. 10-Year Treasury Constant Maturity Minus 3-Month Treasury Constant Maturity 
         Id: T10Y3MM    Period: 1982-01-01 to 2022-02-01  Freq: Monthly*)
(**
...
val it: JsonProvider<...>.InfoResponse =
  {
  "realtime_start": "2022-03-21",
  "realtime_end": "2022-03-21",
  "seriess": [
    {
      "id": "GS10",
      "realtime_start": "2022-03-21",
      ...
      "units": "Percent",
      "units_short": "%",
      "seasonal_adjustment": "Not Seasonally A...*)
(**
...
val it: string[] = [|"Treasury Constant Maturity"|]*)
(**
...
val it: seq<JsonProvider<...>.Observation> =
  seq
    [{
  "realtime_start": "2022-03-21",
  "realtime_end": "2022-03-21",
