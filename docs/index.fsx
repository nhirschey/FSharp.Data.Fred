...
Fred receives an API key as a parameter (`string`). [Get you FRED API key.](https://fred.stlouisfed.org/docs/api/api_key.html)
...
(*** hide ***)
let apiKey = "b1ff5229658ed54b63929049b5feca91"
